...
The project is maintained as a Go CLI with unit tests and GitHub Actions for formatting, tests, and release builds. v1.4.2 is the current public lab-readiness release.
